...
Questo protocollo risulata migliore dell'Aloha puro.
...
Si ha un migliore utilizzo del canale ma aumeta i ritardi.

Esiste anche il CSMA p-persistente, dove p indica la probabilità di trasmettere nel canale se è libero.
A differenza dell 1-persistente, la probabilità sarà minore di 1, quindi potrebbe non trasmettere subito e rimandare a più tardi.
