...
Se ci sono guasti o ostacoli si genera un eco che torna indietro e cronomentrando il tempo di ricezione dell'eco è possibile identificare la distanza dell'origine dell'eco.
...
Nonostante questo è diventato uno stardard per la facilità di gestione e per l'uso dei cablaggi presistenti.
...
L'algoritmi di backoff esponenziale binario è utilizzato per gestire l'attesa casuale dopo una collisione. 
\`E stato scelto perchè si adatta in base al numero di stazioni che tentano di trasmettere.
...
se due stazioni collidono perchè usano lo stesso intervallo, aumenta la scelta degli intervalli casuali (0, 1, 2, 3);
